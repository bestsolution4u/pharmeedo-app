...
const AddCustomer = (props) => {
  ...
  const addCustomerReducer = useSelector(
    (state) => state.customerReducers.addCustomer,
  );
  ...
  const addCustomer = async () => {
    const {saveCustomer} = ActionCreators;
    ...
    try {
      ...
      dispatch(ActionCreators.addCustomer(params));
    } catch (error) {
      setIsAdding(false);
      dropdownAlertRef.current.alertWithType(
        'error',
      ...
      <KeyboardAwareScrollView enableResetScrollToCoords enableOnAndroid>
        <View style={styles.mainContainer}>
          ...
          <Text style={styles.inputLabel}>
            {I18n.t('addCustomer.nameCustomer')}
          </Text>
          <TextInput
          ...
          <TouchableOpacity
            ...
            {isAdding ? (
              ...
              <Text style={styles.lbAddNew}>
                {I18n.t('addCustomer.addCustomer')}
              </Text>
            )}
          </TouchableOpacity>
        </View>
