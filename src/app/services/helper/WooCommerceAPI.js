...
WooCommerceAPI.prototype._request = async function (
  method,
  endpoint,
  newData,
  version = null,
...
WooCommerceAPI.prototype.post = async function (endpoint, data, version) {
  return await this._request('POST', endpoint, data, version);
};

WooCommerceAPI.prototype.put = async function (endpoint, data, version) {
  return await this._request('PUT', endpoint, data, version);
};

WooCommerceAPI.prototype.delete = async function (endpoint, version) {
  return await this._request('DELETE', endpoint, {force: 'true'}, version);
};

WooCommerceAPI.prototype.options = async function (endpoint, version) {
  return await this._request('OPTIONS', endpoint, null, version);
};
